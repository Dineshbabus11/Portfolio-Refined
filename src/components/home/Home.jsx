    ...
    return (
        <div className="home">
            <div className="home-left">
                <img src={HomeImg} alt="Dinesh Babu" />
            </div>
            <div className="home-right">
                <h1>Hi, I'm <span>Dinesh Babu S</span></h1>
                <h2>Web Developer & Problem Solver</h2>
                <p>
                    I'm a B.Tech IT student and Junior Web Developer with experience in building dynamic, user-focused web applications using React.js, REST APIs, and Material UI.
